class TopicDetailData {
  ...
  TopicDetailData copyWith({
    ...
    return TopicDetailData(
      ...
      previousTopicId: previousTopicId ?? this.previousTopicId,
      nextTopicId: nextTopicId ?? this.nextTopicId,
      hasCachedExplanation: hasCachedExplanation ?? this.hasCachedExplanation,
